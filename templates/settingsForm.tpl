...
<div id="plnSettings">
    ...
    <form class="pkp_form" id="deleteIncompleteSubmissionsSettingsForm" method="post"
        ...
        {fbvElement type="select" name="deletionThreshold" id="deletionThreshold" from=$thresholdValues label="plugins.generic.deleteIncompleteSubmissions.settings.deletionThreshold" translate="0" size=$fbvStyles.size.SMALL}
