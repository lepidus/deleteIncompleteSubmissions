...
require_once dirname(__DIR__) . '/classes/SubmissionDeletionPreview.inc.php';
...
class SubmissionDeletionPreviewTest extends TestCase
{
    ...
    public function testCreatedPreviewIsValidForItsIdentifier(): void
    {
        ...
        $this->assertTrue($manager->isValid($preview, $preview['id'], self::THRESHOLD, self::NOW));
    }
    ...
    public function testRejectsExpiredPreview(): void
    {
        ...
        $this->assertFalse($manager->isValid($preview, $preview['id'], self::THRESHOLD, self::NOW + 901));
    }
    ...
    public function testRejectsChangedThreshold(): void
    {
        ...
        $this->assertFalse($manager->isValid($preview, $preview['id'], self::THRESHOLD + 1, self::NOW));
    }
    ...
    public function testRejectsMalformedPreviewState(): void
    {
        ...
        $this->assertFalse($manager->isValid($preview, $preview['id'], self::THRESHOLD, self::NOW));
    }
}
